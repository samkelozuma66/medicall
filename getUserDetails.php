<?php
    ...
    else
    {
        ...
        if ($stmt = $con->prepare('SELECT user_id,name,surname,id_number,Address,Medical_Aid_Name,Medical_Aid_Number, Medical_Aid_Conatct, User_Cellnumber FROM user_details WHERE username = ?')) 
            {
